...
export const presetArticles: Article[] = [
  // ───────────────── TOPIK 1-2 ─────────────────
  {
    ...
    vocabulary: [
      { korean: '일찍', romanization: 'iljjik', meaning: '早', example: '아침에 일찍 일어납니다.', exampleTranslation: '早上很早起床。' },
      { korean: '세수', romanization: 'sessu', meaning: '洗臉', example: '아침에 세수를 합니다.', exampleTranslation: '早上洗臉。' },
      { korean: '버스', romanization: 'beoseu', meaning: '公車', example: '버스로 학교에 갑니다.', exampleTranslation: '搭公車去學校。' },
      { korean: '공부하다', romanization: 'gongbuhada', meaning: '學習', example: '한국어를 공부합니다.', exampleTranslation: '學習韓語。' },
      { korean: '도서관', romanization: 'doseogwan', meaning: '圖書館', example: '도서관에서 공부합니다.', exampleTranslation: '在圖書館學習。' },
      { korean: '숙제', romanization: 'sukje', meaning: '作業', example: '숙제를 합니다.', exampleTranslation: '做作業。' },
      { korean: '저녁', romanization: 'jeonyeok', meaning: '傍晚', example: '저녁에 집에 옵니다.', exampleTranslation: '傍晚回家。' },
      { korean: '쉬다', romanization: 'swida', meaning: '休息', example: '집에서 쉽니다.', exampleTranslation: '在家休息。' },
      { korean: '책', romanization: 'chaek', meaning: '書', example: '책을 읽습니다.', exampleTranslation: '看書。' },
      { korean: '자다', romanization: 'jada', meaning: '睡覺', example: '밤에 잡니다.', exampleTranslation: '晚上睡覺。' },
    ],
    grammar: [
  ...
  },
  {
    ...
    vocabulary: [
      { korean: '가족', romanization: 'gajok', meaning: '家人', example: '우리 가족은 다섯 명입니다.', exampleTranslation: '我的家人有五個人。' },
      { korean: '명', romanization: 'myeong', meaning: '個（計量人數）', example: '세 명이 있습니다.', exampleTranslation: '有三個人。' },
      { korean: '회사원', romanization: 'hoesawon', meaning: '上班族', example: '아버지는 회사원입니다.', exampleTranslation: '爸爸是上班族。' },
      { korean: '출근하다', romanization: 'chulgeunhada', meaning: '上班', example: '매일 출근합니다.', exampleTranslation: '每天上班。' },
      { korean: '요리', romanization: 'yori', meaning: '料理/烹飪', example: '어머니는 요리를 잘 합니다.', exampleTranslation: '媽媽很會做料理。' },
      { korean: '대학생', romanization: 'daehaksaeng', meaning: '大學生', example: '언니는 대학생입니다.', exampleTranslation: '姐姐是大學生。' },
      { korean: '중학생', romanization: 'junghaksaeng', meaning: '國中生', example: '남동생은 중학생입니다.', exampleTranslation: '弟弟是國中生。' },
      { korean: '축구', romanization: 'chukgu', meaning: '足球', example: '축구를 좋아합니다.', exampleTranslation: '喜歡踢足球。' },
      { korean: '주말', romanization: 'jumal', meaning: '週末', example: '주말에 등산을 갑니다.', exampleTranslation: '週末去爬山。' },
      { korean: '등산', romanization: 'deungsan', meaning: '登山/爬山', example: '등산을 좋아합니다.', exampleTranslation: '喜歡爬山。' },
    ],
    grammar: [
  ...
  // ───────────────── TOPIK 3-4 ─────────────────
  {
    ...
    vocabulary: [
      { korean: '사계절', romanization: 'sagyejeol', meaning: '四季', example: '한국은 사계절이 뚜렷합니다.', exampleTranslation: '韓國四季分明。' },
      { korean: '뚜렷하다', romanization: 'tturyeotada', meaning: '分明/鮮明', example: '사계절이 뚜렷합니다.', exampleTranslation: '四季分明。' },
      { korean: '벚꽃', romanization: 'beotkkot', meaning: '櫻花', example: '벚꽃이 아름답게 핍니다.', exampleTranslation: '櫻花美麗地盛開。' },
      { korean: '붐비다', romanization: 'bumbida', meaning: '擁擠/熱鬧', example: '공원이 사람들로 붐빕니다.', exampleTranslation: '公園擠滿了人。' },
      { korean: '장마', romanization: 'jangma', meaning: '梅雨季', example: '장마 기간에 비가 많이 옵니다.', exampleTranslation: '梅雨季節下很多雨。' },
      { korean: '단풍', romanization: 'danpung', meaning: '楓葉/紅葉', example: '가을에 단풍이 아름답습니다.', exampleTranslation: '秋天紅葉很美麗。' },
      { korean: '맑다', romanization: 'makda', meaning: '晴朗', example: '가을 하늘이 맑습니다.', exampleTranslation: '秋天天空晴朗。' },
      { korean: '스키장', romanization: 'seukijang', meaning: '滑雪場', example: '스키장을 찾는 사람이 많습니다.', exampleTranslation: '去滑雪場的人很多。' },
      { korean: '매력', romanization: 'maeryeok', meaning: '魅力', example: '한국은 매력이 있습니다.', exampleTranslation: '韓國很有魅力。' },
      { korean: '경험', romanization: 'gyeongheom', meaning: '經驗/體驗', example: '즐거운 경험을 합니다.', exampleTranslation: '有愉快的體驗。' },
    ],
    grammar: [
  ...
  },
  {
    ...
    vocabulary: [
      { korean: '재료', romanization: 'jaeryo', meaning: '食材/材料', example: '건강에 좋은 재료를 사용합니다.', exampleTranslation: '使用對健康有益的食材。' },
      { korean: '조리', romanization: 'jori', meaning: '烹調', example: '다양한 조리 방법이 있습니다.', exampleTranslation: '有各種烹調方法。' },
      { korean: '발효', romanization: 'balhyo', meaning: '發酵', example: '김치는 발효 식품입니다.', exampleTranslation: '泡菜是發酵食品。' },
      { korean: '유산균', romanization: 'yusangyun', meaning: '乳酸菌', example: '유산균이 풍부합니다.', exampleTranslation: '富含乳酸菌。' },
      { korean: '반찬', romanization: 'banchan', meaning: '小菜/配菜', example: '밥상에 반찬이 많이 나옵니다.', exampleTranslation: '飯桌上有很多小菜。' },
      { korean: '한류', romanization: 'hallyu', meaning: '韓流', example: '한류의 영향이 큽니다.', exampleTranslation: '韓流的影響很大。' },
      { korean: '관심', romanization: 'gwansim', meaning: '關注/興趣', example: '한국 음식에 관심이 높아졌습니다.', exampleTranslation: '對韓國飲食的關注提高了。' },
      { korean: '단순히', romanization: 'dansunhi', meaning: '單純地/僅僅', example: '단순히 먹는 것이 아닙니다.', exampleTranslation: '不僅僅是吃東西。' },
      { korean: '나누다', romanization: 'nanuda', meaning: '分享', example: '함께 나누어 먹습니다.', exampleTranslation: '一起分享著吃。' },
      { korean: '반영하다', romanization: 'banyeonghada', meaning: '反映', example: '문화를 반영합니다.', exampleTranslation: '反映文化。' },
    ],
    grammar: [
  ...
  // ───────────────── TOPIK 5-6 ─────────────────
  {
    ...
    vocabulary: [
      { korean: '급속한', romanization: 'geupsokan', meaning: '急速的', example: '급속한 발전이 이루어졌습니다.', exampleTranslation: '實現了急速的發展。' },
      { korean: '혁명적', romanization: 'hyeongmyeongjeok', meaning: '革命性的', example: '혁명적인 변화가 일어났습니다.', exampleTranslation: '發生了革命性的變化。' },
      { korean: '융합', romanization: 'yunghap', meaning: '融合', example: '두 기술이 융합됩니다.', exampleTranslation: '兩種技術融合。' },
      { korean: '전례 없는', romanization: 'jeollye eomneun', meaning: '前所未有的', example: '전례 없는 혁신입니다.', exampleTranslation: '是前所未有的創新。' },
      { korean: '획기적', romanization: 'hoekgijeok', meaning: '劃時代的/突破性的', example: '획기적인 방법을 개발했습니다.', exampleTranslation: '開發了突破性的方法。' },
      { korean: '가속화', romanization: 'gaseokwa', meaning: '加速化', example: '디지털화가 가속화됩니다.', exampleTranslation: '數位化加速進行。' },
      { korean: '격차', romanization: 'gyeokcha', meaning: '落差/差距', example: '디지털 격차가 심각합니다.', exampleTranslation: '數位落差很嚴重。' },
      { korean: '불평등', romanization: 'bulpyeongdeung', meaning: '不平等', example: '사회적 불평등이 심화됩니다.', exampleTranslation: '社會不平等加深。' },
      { korean: '구현하다', romanization: 'guhyeonhada', meaning: '實現/體現', example: '지속 가능한 사회를 구현합니다.', exampleTranslation: '實現可持續的社會。' },
      { korean: '윤리적', romanization: 'yunnijeok', meaning: '倫理的/道德的', example: '윤리적 규범이 필요합니다.', exampleTranslation: '需要倫理規範。' },
    ],
    grammar: [
  ...
  },
  {
    ...
    vocabulary: [
      { korean: '직면하다', romanization: 'jingmyeonhada', meaning: '面臨', example: '위기에 직면했습니다.', exampleTranslation: '面臨了危機。' },
      { korean: '온실가스', romanization: 'onsil gaseu', meaning: '溫室氣體', example: '온실가스 배출을 줄여야 합니다.', exampleTranslation: '必須減少溫室氣體排放。' },
      { korean: '초래하다', romanization: 'choraehaда', meaning: '導致/引起', example: '기후 변화를 초래합니다.', exampleTranslation: '導致氣候變遷。' },
      { korean: '해수면', romanization: 'haesu myeon', meaning: '海平面', example: '해수면이 상승하고 있습니다.', exampleTranslation: '海平面正在上升。' },
      { korean: '생물 다양성', romanization: 'saengmul dayangseong', meaning: '生物多樣性', example: '생물 다양성이 감소합니다.', exampleTranslation: '生物多樣性減少。' },
      { korean: '탄소 중립', romanization: 'tanso jungnip', meaning: '碳中和', example: '탄소 중립을 목표로 합니다.', exampleTranslation: '以碳中和為目標。' },
      { korean: '양립', romanization: 'yangnip', meaning: '兼容/並立', example: '경제 성장과의 양립이 어렵습니다.', exampleTranslation: '與經濟成長的兼容很困難。' },
      { korean: '재생 가능', romanization: 'jaeseong ganeung', meaning: '可再生的', example: '재생 가능 에너지가 중요합니다.', exampleTranslation: '可再生能源很重要。' },
      { korean: '근본적', romanization: 'geunbonjeok', meaning: '根本性的', example: '근본적인 변화가 필요합니다.', exampleTranslation: '需要根本性的改變。' },
      { korean: '물려주다', romanization: 'mullyeojuda', meaning: '傳承/留下給', example: '다음 세대에게 물려줍니다.', exampleTranslation: '傳承給下一代。' },
    ],
    grammar: [
